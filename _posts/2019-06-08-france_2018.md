...
> A meaningful AI is another way to say that it is not an end in itself. Its development should take several considerations into account.
...
## Part 6 — For Inclusive and Diverse Artificial Intelligence

This section focuses on the diversity problem in AI, especially the lack of females and members of minority demographics in the sector.

The first subsection focuses on the lack of females in the sector, with proposed solutions including financial incentives for institutions that achieve more equal gender ratios and public outreach with both male and female ambassadors.

The second subsection focuses on ensuring that AI benefits all demographics equally. This is manifested in several ways.

- Ensuring that technologically-enabled governmental services remain accessible to all demographics
- Basic AI training for government officials and civil servants
